 ...
 * @version $Id: timeselect.php 635 2009-08-23 12:57:09Z deutz $
 **/
...
echo '<label for="', $elm1, '" class="time" >', JText::_ ( $namedesc1 );
echo ' </label>';
echo '<label for="', $elm2, '" class="time" >', JText::_ ( $namedesc2 );
