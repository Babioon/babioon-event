...
function datePicker(options) {
        ...
        o.resize = function() {
                ...
                o.div.style.display = "none";
                o.div.style.background= "none";


                if(!o.staticPos) {
                        // RD: table is on the right postion in the DOM 
                        ...
                        if(parseInt(trueBody.clientWidth+scrollLeft) < parseInt(osw+pos[0]+elem.offsetWidth+5)) {
                            o.div.style.left = parseInt(- osw - 5) + "px";
                        } else {
                            o.div.style.left = parseInt(5 + elem.offsetWidth) + "px";
                        };
                        if(parseInt(trueBody.clientHeight+scrollTop) < parseInt(osh+pos[1]+elem.offsetHeight+2)) {
                            o.div.style.top   = parseInt(- osh - 5) + "px";
                        } else {
                            o.div.style.top   = parseInt(5 + elem.offsetHeight) + "px";
                        };
                };
                /*@cc_on
        ...
        o.createButton = function() {
                ...
                if(!document.getElementById("fd-but-" + o.id)) {
                        ...
                        span.className = (typeof(fdLocale) == "object" && options.locale && fdLocale.classes.length > 0) ? fdLocale.classes[0] : "";
                        //span.className = "unsichtbar";

                                                var textopen = (typeof(fdLocale) == "object" && options.locale && fdLocale.titles.length > 5) ? fdLocale.titles[5] : String.fromCharCode( 160 );
                        span.appendChild(document.createTextNode(textopen));
                        ...
                        if(inp.nextSibling) {
                                inp.parentNode.insertBefore(block, inp.nextSibling);
                        } else {
                                inp.parentNode.appendChild(block);
                        };
                } else {
        ...
        o.create = function() {
                ...
                if(!o.staticPos) {
                        ...
                        //alert('tablediv');
                        document.getElementById('fd-but-'+o.id).parentNode.insertBefore(o.div,document.getElementById('fd-but-'+o.id).nextSibling)
                        //document.getElementById(o.id).parentNode.insertBefore(o.div,document.getElementById(o.id).nextSibling)
                } else {
                        elem = o.getElem();
                        if(!elem) {
                                o.div = null;
